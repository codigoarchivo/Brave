...
import { COLOR_FIVE, COLOR_TWO, COLOR_SIX } from '../../utils';
                ...
                <Stack spacing={1}>
                    ...
                    <Stack
                        ...
                        <a
                            ...
                            target={'_blank'}
                        ><LinkedInIcon color='secondary' /></a>
                        <a
                            style={{ color: 'currentcolor' }}
                            href="https://www.linkedin.com/in/jackson-quintero/"
                            target={'_blank'}
                    ...
                    <Stack
                        ...
                        <a
                            ...
                            target={'_blank'}
                        ><FacebookIcon color='secondary' /></a>
                        <a
                            style={{ color: 'currentcolor' }}
                            href="https://www.facebook.com/jacksonjose.quinteroangulo/"
                            target={'_blank'}
                    ...
                    <Stack
                        ...
                        <a
                            ...
                            target={'_blank'}
                        ><TelegramIcon color='secondary' /></a>
                        <a
                            style={{ color: 'currentcolor' }}
                            href="https://t.me/jackyire"
                            target={'_blank'}
                    ...
                    <Stack
                        ...
                        <a
                            ...
                            target={'_blank'}
                        ><WhatsAppIcon color='secondary' /></a>
                        <a
                            style={{ color: 'currentcolor' }}
