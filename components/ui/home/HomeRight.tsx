...
export const HomeRight = () => {
    return (
        <>
            ...
            <Box className={styles['box__background-transparents']} sx={{ position: 'absolute', border: 'solid', bottom: 20, left: 20, backgroundColor: 'trasparents', height: { xs: '30vh', sm: '41vh', md: '71vh' }, width: { xs: '60%', sm: '58%', md: '68%' } }}></Box>
